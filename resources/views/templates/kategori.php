		  ...
		  <div class="container">
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		        <ul class="nav navbar-nav navbar-right">
			        <li><a href="index.html">Apero bestellen</a></li>
			        <li class="active"><a href="hillfe.html">Hilfe</a></li>
				...
				<div class="row">
					...
					<div class="col-md-9 col-sm-8">
						...
						<div class="apero-kat clearfix">
							...
							<div class="col-md-12 anbieter-kat-item">
									...
									<div class="kategori-item">
										<form name="myForm" ng-controller="ExampleController">
										  <label>
										    ...
										    <i class="fa fa-shopping-cart btn" aria-hidden="true"></i>
										  </label>
										  <label>
										  	<span>Label:</span>
										    <input type="number" name="input" ng-model="example.value" min="0" max="99" required>
						...
						<div class="filter bestellung">
							...
							<div class="filter-content">
								<form action="" class="clearfix">
									...
									<div class="bestellung-produkt-number">
										<p>2x Produkt 1 <span class="bestellung-produkt-number-price">10.50</span></p>
										<p>1x Produkt 2 <span class="bestellung-produkt-number-price">11.20</span></p>
									</div>
